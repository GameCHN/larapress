...
@section('body')
    ...
    <div class="wrapper">
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2011-{{ date('Y') }} <a
                        href="{{ Cache::get('system_author_website', 'http://douyasi.com') }}">{{ Cache::get('system_author','豆芽丝') }}</a></strong>
            芽丝内容管理框架(<code>YASCMF</code>) 版本: v1.0
        </footer>
